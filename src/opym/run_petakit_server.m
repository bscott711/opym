            ...
            otherwise
                ...
                if val_deskew || val_rotate
                    ...
                    XR_deskew_rotate_data_wrapper( ...
                        ...
                        'objectiveScan', false, ...
                        'zStageScan', true, ...       % Maps the galvo sweep to the shear matrix
                        'reverse', true, ...          % 🔑 Flips the shear direction to subtract the galvo skew!
                        'DSRCombined', false, ...     % 🔑 Bypasses the Java memory crash
                        'save16bit', true, ...
                        'save3DStack', true, ...
                        'saveMIP', false, ...         % 🔑 Skips CPU-intensive 2D projections
                        'parseCluster', false, ...
                        'parseParfor', false, ...
                        'masterCompute', true, ...
                        'cpusPerTask', numCPUs ...
