...
% memory and bypasses disk I/O.
    ...
    % The legacy wrapper subtracted the galvo angle from 90.
    adjusted_angle = 90.0 - abs(pr.SkewAngle);
    
    % Keep on GPU for DSR as requested!
    dsr_gpu = deskewRotateFrame3D(deconvolved, adjusted_angle, pr.z_step_um, pr.xyPixelSize, ...
        'reverse', pr.Reverse, ...
        'Crop', true, ...
